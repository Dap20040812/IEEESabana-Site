        ...
        <Form onSubmit={submitHandler}>
            ...
            <Field>
                ...
                <Ifield value={userName} onChange={(e) => {setUserName(e.target.value) 
                    setErrors({})}}  autocomplete="off" placeholder="Username" class="input-field" type="text"/>
            </Field>
            ...
            <Field>
                ...
                <Ifield value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" class="input-field" type="password"/>
            </Field>
